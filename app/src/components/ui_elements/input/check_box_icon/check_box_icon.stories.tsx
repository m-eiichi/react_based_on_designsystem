...
import { type CheckBoxIconProps } from "@/components/ui_elements/input/check_box_icon/types";

import { createAnyValidate } from "@/utils/validation";

// args で渡す用の Storybook 拡張型
type Args = CheckBoxIconProps & {
...
const meta: Meta<Args> = {
  ...
  component: CheckBoxIcon as unknown as ComponentType<Args>,
  tags: ["autodocs"],
  argTypes: {
    style: {
      control: "object",
...
export const CheckBoxIconSample: Story = {
  args: {
    style: {},
    id: "checkbox-id",
    value: "1",
  ...
  render: ({ ...args }) => {
    const elm_name = "check_box_icon_elm";
